...
describe('001 Deprecations', function () {
    describe('older version passed', function () {
        const options = {checkVersion: 'v1'};

        it('[failure] theme is invalid', function (done) {
            utils.testCheck(thisCheck, '001-deprecations/invalid', options).then(function (output) {
        ...
        it('[success] should show no error if no deprecated helpers used', function (done) {
            utils.testCheck(thisCheck, '001-deprecations/valid', options).then(function (output) {
                output.should.be.a.ValidThemeObject();
        ...
        it('[mixed] should pass and fail when some rules pass and others fail', function (done) {
            utils.testCheck(thisCheck, '001-deprecations/mixed', options).then(function (output) {
                output.should.be.a.ValidThemeObject();
        ...
        // TODO: write this as soon as we have new rules
        it('does not check for latest versions checks');
    });
