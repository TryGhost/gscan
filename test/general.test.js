...
describe('format', function () {
    ...
    it('formats for CLI output', function () {
        return checker(themePath('001-deprecations/latest/invalid_all')).then((theme) => {
            ...
            theme.results.error[0].details.should.endWith(`Find more information about the \u001b[36m{{page_url}}\u001b[39m helper here (https://docs.ghost.org/api/handlebars-themes/helpers/pagination/).`);
        });
    });
});
