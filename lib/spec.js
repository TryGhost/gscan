...
rules = {
    ...
    "GS001-DEPR-IMG": {
        "level": "error",
        "rule": "Replace the <code>{{image}}</code> helper with <code>{{feature_image}}</code> or <code>{{profile_image}}</code>.",
        "fatal": true
    },
    "GS001-DEPR-COV": {
        "level": "error",
    ...
    "GS001-DEPR-CON-IMG": {
        ...
        "{{#if cover_image}}</code>, or <code>{{#if profile_image}}</code>.",
        "fatal": true
    },
    "GS001-DEPR-CON-BC": {
        "level": "error",
    ...
    "GS010-PJ-VERSION-SEM": {
        "level": "error",
        "rule": "package.json <code>version</code> must be semver compliant (e.g. 1.0.0)."
    },
