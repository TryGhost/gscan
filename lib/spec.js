...
rules = {
    ...
    'GS005-FOREACH-REQ': {
        level: 'warning',
        rule: 'Should use ghost specific foreach instead of each',
        fatal: false,
        details: 'The {{#foreach}} helper is context-aware and should always be used instead of Handlebars each when working with Ghost themes.<br>' +
                   'See the describtion of {{#foreach}} helper <a href="https://themes.ghost.org/docs/foreach" target=_blank>here</a>.'
    },
    'GS010-PJ-REQ': {
        level: 'error',
