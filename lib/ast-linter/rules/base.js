...
module.exports = class BaseRule {
    ...
    getVisitor() {
        ...
        // before the rule-specific visitor so that BlockStatement rules are
        // run in the current context rather than their own context
        ...
        // statement's body
        // NOTE: must happen after popping unknown frames so that we don't
        // unintentionally pop the frame we've just pushed
