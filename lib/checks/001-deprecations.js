...
checkDeprecations = function checkDeprecations(theme, themePath, options) {
    options = _.extend({
        detectDeprecatedCSSErrors: true
    }, options || {});
    ...
    _.each(checks, function (check) {
        _.each(theme.files, function (themeFile) {
            ...
            } else if (css && check.css && options.detectDeprecatedCSSErrors) {
                try {
