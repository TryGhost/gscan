...
checkDeprecations = function checkDeprecations(theme, themePath) {
    var checks = [
        {
            helperRegEx: /{{[\s\S]?pageUrl[\s\S]?}}/ig,
            helperName: '{{pageUrl}}',
