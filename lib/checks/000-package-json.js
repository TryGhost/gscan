...
checkPackageJSON = function checkPackageJSON(themePath, themeFiles) {
    var out = {
            errors: [],
            warnings: [],
            recommendations: []
        ...
        packageJSONPath = path.join(themePath, packageJSONFile),
        result,
        contents;

    if (!_.some(themeFiles, {file: packageJSONFile})) {
        // file doesn't exist
