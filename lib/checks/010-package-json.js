...
_private.validatePackageJSONFields = function validatePackageJSONFields(packageJSON, theme, packageJSONValidationRules) {
    ...
    if (packageJSON.config && packageJSON.config.custom) {
        ...
        if (customSettingsKeys.length > 15) {
...
module.exports = function checkPackageJSON(theme, options) {
    ...
    if (checkVersion === 'v1') {
        ...
        packageJSONValidationRules = _.merge({}, v1PackageJSONValidationRules, v2PackageJSONValidationRules, v3PackageJSONValidationRules, v4PackageJSONValidationRules, canaryPackageJSONValidationRules);
        packageJSONConditionalRules = _.merge({}, v1PackageJSONConditionalRules, v2PackageJSONConditionalRules, v3PackageJSONConditionalRules, v4PackageJSONConditionalRules, canaryPackageJSONConditionalRules);
    } else {
        // default check for current version 'v4' rules
        packageJSONValidationRules = _.merge({}, v1PackageJSONValidationRules, v2PackageJSONValidationRules, v3PackageJSONValidationRules, v4PackageJSONValidationRules);
        packageJSONConditionalRules = _.merge({}, v1PackageJSONConditionalRules, v2PackageJSONConditionalRules, v3PackageJSONConditionalRules, v4PackageJSONConditionalRules);
    }
