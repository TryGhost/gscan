 ...
 */
const ghostVersions = require('../utils').versions.v1;
const docsBaseUrl = `https://themes.ghost.org/v${ghostVersions.docs}/docs/`;
...
rules = {
    'GS001-DEPR-PURL': {
        ...
        Find more information about the <code>{{page_url}}</code> helper <a href="${docsBaseUrl}page_url" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-MD': {
        ...
        Check out the documentation for <code>{{meta_description}}</code> <a href="${docsBaseUrl}meta_description" target=_blank>here</a>.<br>
        To see, what else is rendered with the <code>{{ghost_head}}</code> helper, look <a href="${docsBaseUrl}ghost_head" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-IMG': {
        ...
        <br><br>Find more information about the <code>{{img_url}}</code> helper <a href="${docsBaseUrl}img_url" target=_blank>here</a> and
        read more about Ghost's usage of contexts <a href="${docsBaseUrl}context-overview" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-COV': {
        ...
        See the object attributes of <code>author</code> <a href="${docsBaseUrl}author-context#section-author-object-attributes" target=_blank>here</a>.<br>
        To render the cover image of your blog, just use <code>{{@blog.cover_image}}</code>. See <a href="${docsBaseUrl}blog" target=_blank>here</a>.`,
        regex: /{{\s*?cover\s*?}}/g,
        helper: '{{cover}}'
    },
    'GS001-DEPR-AIMG': {
    ...
    'GS001-DEPR-PIMG': {
        ...
        See the object attributes of <code>post</code> <a href="${docsBaseUrl}post-context#section-post-object-attributes" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-BC': {
        ...
        See <a href="${docsBaseUrl}blog" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-TIMG': {
        ...
        See the object attributes of <code>tags</code> <a href="${docsBaseUrl}tag-context#section-tag-object-attributes" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-CON-IMG': {
        ...
        Depending on the <a href="${docsBaseUrl}context-overview" target=_blank>context</a> you will need to replace it like this:<br><br>
        <code>{{#author}}<br>
        &nbsp;&nbsp;&nbsp;&nbsp;{{#if profile_image}}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{profile_image}}<br>&nbsp;&nbsp;&nbsp;&nbsp;{{/if}}<br>
        {{/author}}</code><br><br>
        See the object attributes of <code>author</code> <a href="${docsBaseUrl}author-context#section-author-object-attributes" target=_blank>here</a>.<br><br>
        <code>{{#post}}<br>
        &nbsp;&nbsp;&nbsp;&nbsp;{{#if feature_image}}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{feature_image}}<br>&nbsp;&nbsp;&nbsp;&nbsp;{{/if}}<br>
        {{/post}}</code><br><br>
        See the object attributes of <code>post</code> <a href="${docsBaseUrl}post-context#section-post-object-attributes" target=_blank>here</a>.<br><br>
        <code>{{#tag}}<br>
        &nbsp;&nbsp;&nbsp;&nbsp;{{#if feature_image}}<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{feature_image}}<br>&nbsp;&nbsp;&nbsp;&nbsp;{{/if}}<br>
        {{/tag}}</code><br><br>
        See the object attributes of <code>tags</code> <a href="${docsBaseUrl}tag-context#section-tag-object-attributes" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-CON-COV': {
        ...
        See the object attributes of <code>author</code> <a href="${docsBaseUrl}author-context#section-author-object-attributes" target=_blank>here</a>.<br>
        To check for the cover image of your blog, just use <code>{{#if @blog.cover_image}}</code>. See <a href="${docsBaseUrl}blog" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-PPP': {
        ...
        Read <a href="${docsBaseUrl}config" target=_blank>here</a> about the attribute and
        check <a href="${docsBaseUrl}packagejson#section--config-posts_per_page-" target=_blank>here</a> where you can customise the posts per page setting, as this is now adjustable in your theme.`,
    ...
    'GS001-DEPR-C0H': {
        ...
        details: `The <code>{{content words="0"}}</code> hack doesn't work anymore (and was never supported).<br>
        Find more information about the <code>{{img_url}}</code> helper <a href="${docsBaseUrl}img_url" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-CSS-AT': {
        ...
        See the <a href="${docsBaseUrl}context-overview#section-context-table" target=_blank>context table</a> to check which classes Ghost uses for each context.`,
    ...
    'GS002-DISQUS-ID': {
        ...
        fatal: true,
        details: `The output of <code>{{id}}</code> has changed in v1.0.0 from an incremental ID to an ObjectID. 
    ...
    'GS010-PJ-NAME-LC': {
        ...
        Check the <a href="${docsBaseUrl}packagejson#section--name-" target=_blank><code>package.json</code> documentation</a> for further information.`
    },
    'GS010-PJ-NAME-HY': {
        level: 'error',
    ...
    'GS010-PJ-VERSION-SEM': {
        ...
        Check the <a href="${docsBaseUrl}packagejson#section--version-" target=_blank><code>package.json</code> documentation</a> for further information.`
    },
    ...
    'GS010-PJ-AUT-EM-VAL': {
        ...
        Check the <a href="${docsBaseUrl}packagejson#section--author-" target=_blank><code>package.json</code> documentation</a> for further information.`
    },
    'GS010-PJ-CONF-PPP': {
        level: 'recommendation',
        ...
        Check the <a href="${docsBaseUrl}packagejson#section--config-posts_per_page-" target=_blank><code>package.json</code> documentation</a> for further information.`
    },
    ...
    'GS020-INDEX-REQ': {
        ...
        Read <a href="${docsBaseUrl}templates" target=_blank>here</a> more about the required template structure and <code>index.hbs</code> in <a href="${docsBaseUrl}templates#section-index-hbs" target=_blank>particular</a>.`,
        path: 'index.hbs'
    },
    'GS020-POST-REQ': {
        level: 'error',
    ...
    'GS030-ASSET-REQ': {
        ...
        For more information, please see the <a href="${docsBaseUrl}asset" target=_blank><code>{{asset}}</code> helper documentation</a>.`,
    ...
    'GS040-GH-REQ': {
        ...
        For more details, please see the <a href="${docsBaseUrl}ghost_head" target=_blank><code>{{ghost_head}}</code> helper documentation</a>.`,
        helper: 'ghost_head'
    },
    'GS040-GF-REQ': {
        level: 'warning',
        ...
        For more details, please see the <a href="${docsBaseUrl}ghost_foot" target=_blank><code>{{ghost_foot}}</code> helper documentation</a>.`,
        helper: 'ghost_foot'
    }
};
