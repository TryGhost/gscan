...
rules = {
    ...
    'GS001-DEPR-COV': {
        ...
        To render the cover image of your blog, just use <code>{{@site.cover_image}}</code>. See <a href="${docsBaseUrl}blog" target=_blank>here</a>.`,
        regex: /{{\s*?cover\s*?}}/g,
        helper: '{{cover}}'
    },
    'GS001-DEPR-AIMG': {
    ...
    'GS001-DEPR-CON-COV': {
        ...
        See the object attributes of <code>author</code> <a href="${docsBaseUrl}author-context#section-author-object-attributes" target=_blank>here</a>.<br>
        To check for the cover image of your blog, just use <code>{{#if @site.cover_image}}</code>. See <a href="${docsBaseUrl}blog" target=_blank>here</a>.`,
