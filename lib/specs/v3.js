...
// Add recursive partial check rule (critical for all versions)
rules['GS091-RECURSIVE-PARTIAL'] = {
    level: 'error',
    fatal: true,
    rule: 'Recursive partial inclusion detected',
    details: oneLineTrim`Recursive or circular partial inclusions will cause infinite render loops and crash your theme.
    A partial cannot include itself either directly or through a chain of other partials.<br>
    Learn more about partials <a href="${docsBaseUrl}structure/#partials" target=_blank>here</a>.`
};
