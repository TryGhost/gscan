...
let rules = {
    ...
    'GS010-PJ-GHOST-API-PRESENT': {
        ...
        details: oneLineTrim`The <code>"ghost-api"</code> version is no longe rused and so can be removed from your <code>package.json</code>.<br>
    ...
    'GS001-DEPR-LANG': {
        ...
        details: oneLineTrim`Replace <code>{{lang}}</code> with <code>{{@site.locale}}</code>.<br>
    ...
    'GS001-DEPR-SITE-LANG': {
        ...
        details: oneLineTrim`Replace <code>{{@site.lang}}</code> with <code>{{@site.locale}}</code>.<br>
    ...
    'GS001-DEPR-USER-GET': {
        ...
        details: oneLineTrim`The usage of <code>{{#get "users"}}</code> is no longer supported and will not return any data. It should be replaced with <code>{{#get "authors"}}</code>.<br>
        Find more information about the <code>{{get}}</code> helper <a href="${docsBaseUrl}helpers/get/" target=_blank>here</a>.`,
