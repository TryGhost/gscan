...
let rules = {
    ...
    'GS081-FIMG-CAPTION': {
        level: 'recommendation',
        rule: 'The <code>{{feature_image_caption}}</code> helper should be present',
        details: oneLineTrim`The <code>{{feature_image_caption}}</code> helper should be present in your theme. Ghost's editor allows additional data to be attached to a post's feature image, without the helper that data won't be shown and will not match user expectations.`,
        regex: /feature_image_caption/g,
        helper: '{{feature_image_caption}}'
    },
    'GS081-FIMG-ALT': {
        level: 'recommendation',
        rule: 'The <code>{{feature_image_alt}}</code> helper should be present',
        details: oneLineTrim`The <code>{{feature_image_alt}}</code> helper should be present in your theme. Ghost's editor allows additional data to be attached to a post's feature image, without the helper that data won't be shown and will not match user expectations.`,
        regex: /feature_image_alt/g,
        helper: '{{feature_image_alt}}'
    },
    'GS001-DEPR-CURR-SYM': {
        level: 'warning',
