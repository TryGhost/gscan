...
let rules = {
    ...
    'GS050-CUSTOM-FONT-HEADING': {
        level: 'warning',
        rule: `The <code>--gh-font-heading</code> CSS custom property is required to support custom fonts in your theme`,
        details: oneLineTrim`The <code>--gh-font-heading</code> CSS custom property is required otherwise heading font setting will have no effect`,
        regex: /--gh-font-heading/g
    },
    'GS050-CUSTOM-FONT-BODY': {
        level: 'warning',
        rule: `The <code>--gh-font-body</code> CSS custom property is required to support custom fonts in your theme`,
        details: oneLineTrim`The <code>--gh-font-body</code> CSS custom property is required otherwise body font setting will have no effect`,
        regex: /--gh-font-body/g
    }
};
