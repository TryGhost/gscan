...
let rules = {
    ...
    'GS010-PJ-GHOST-CARD-ASSETS-NOT-PRESENT': {
        level: 'warning',
        rule: '<code>"card_assets"</code> will default as true in <code>package.json</code> ',
        details: oneLineTrim`The <code>"code_assets"</code> config is enabled by default if not explicitly set.<br>
        Find more information about the <code>card_assets</code> config <a href="${docsBaseUrl}/content/#editor-cards" target=_blank>here</a>.`
    },
