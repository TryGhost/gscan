...
let rules = {
    ...
    'GS110-NO-MISSING-PAGE-BUILDER-USAGE': {
        ...
        details: oneLineTrim`Some page features used via the <code>{{@page}}</code> global are not being used.&nbsp;
        Check the <a href="${docsBaseUrl}helpers/page" target=_blank>page</a> helper documentation for further information.`
    },

    'GS110-NO-UNKNOWN-PAGE-BUILDER-USAGE': {
        level: 'error',
        fatal: true,
        rule: 'Unsupported page feature used',
