...
let rules = {
    ...
    'GS050-CSS-KGAUDPLCON': cssCardRule('audio', 'kg-player-container'),
    'GS050-CSS-KGAUDTI': cssCardRule('audio', 'kg-audio-title'),
    'GS050-CSS-KGAUDPL': cssCardRule('audio', 'kg-player'),
    'GS050-CSS-KGAUDPLCNT': cssCardRule('audio', 'kg-player-container'),
