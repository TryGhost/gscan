...
let rules = {
    ...
    'GS090-NO-PRICE-DATA-HELPER': {
        ...
        details: oneLineTrim`The <code>{{@price}}</code> data helper has been deprecated in favor of <code>{{price}}</code> with <code>{{@member.subscriptions}}</code><br>
        The <code>{{@price}}</code> helper was removed in Ghost v5 and should not be used.
        Find more information about the <code>{{price}}</code> property <a href="${docsBaseUrl}members/#the-price-helper" target=_blank>here</a>.`,
        helper: '{{@price}}'
    },
