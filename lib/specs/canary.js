...
let rules = {
    ...
    'GS090-NO-PRICE-DATA-CURRENCY-GLOBAL': {
        level: 'error',
        fatal: true,
        rule: 'Replace <code>{{@price.currency}}</code> with <code>{{currency}}</code> and <code>{{#get "tiers"}}</code> or <code>{{#foreach @member.subscriptions}}</code>',
        details: oneLineTrim`There is no longer a global <code>@price</code> object. You need to use either <code>{{#get "tiers"}}</code> to fetch all tiers
        or <code>{{#foreach @member.subscriptions}}</code> to fetch an individual member's subscriptions, and use the {{currency}} property from those contexts.`
    },
    'GS090-NO-PRICE-DATA-CURRENCY-CONTEXT': {
        level: 'error',
        fatal: true,
        rule: 'Replace <code>{{@price.currency}}</code> with <code>{{currency}}</code>',
        details: oneLineTrim`There is no longer a global <code>@price</code> object. Instead the <code>{{currency}}</code> property can be used
        from your <code>{{#get "tiers"}}</code> or <code>{{#foreach @member.subscriptions}}</code> objects.`
    },
    'GS090-NO-TIER-PRICE-AS-OBJECT': {
        ...
        ${tierDesc}<br>
        Find more information about the <code>{{#get "tiers"}}</code> <a href="${docsBaseUrl}helpers/get/" target=_blank>here</a>.`,
        helper: '{{#get "tiers"}}'
    },
