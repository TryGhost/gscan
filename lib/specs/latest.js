...
rules = {
    ...
    'GS001-DEPR-USER-GET': {
        ...
        details: `The usage of <code>{{#get "users"}}</code> is deprecated and should be replaced with <code>{{#get "authors"}}</code>.<br>
    ...
    'GS001-DEPR-PAID': {
        ...
        details: `The <code>{{post.author_id}}</code> attribute in post context was removed<br>
    ...
    'GS001-DEPR-BLOG': {
        ...
        details: `With the introduction of the Content API <code>{{@blog}}</code> became deprecated in favour of <code>{{@site}}</code>.<br>
        The <code>{{@blog}}</code> helper will be removed in next version of Ghost and should not be used.
        Find more information about the <code>@site</code> property <a href="${docsBaseUrl}site" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-SPL': {
        ...
        Find more information about the <code>@site</code> property <a href="${docsBaseUrl}blog" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-SGH': {
        ...
        details: `The usage of <code>{{@site.ghost_head}}</code> is deprecated and should be replaced with <code>{{ghost_head}}</code>.<br>
        The <code>{{@site.ghost_head}}</code> property will therefore no longer be used and should be removed from the theme.
        Find more information about the <code>{{ghost_head}}</code> property <a href="${docsBaseUrl}ghost_head" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-SGF': {
        ...
        details: `The usage of <code>{{@site.ghost_foot}}</code> is deprecated and should be replaced with <code>{{ghost_foot}}</code>.<br>
        The <code>{{@site.ghost_foot}}</code> property will therefore no longer be used and should be removed from the theme.
        Find more information about the <code>{{ghost_foot}}</code> property <a href="${docsBaseUrl}ghost_foot" target=_blank>here</a>.`,
    ...
    'GS001-DEPR-LANG': {
        ...
        details: `The <code>{{lang}}</code> helper is a duplicate of <code>{{@site.lang}}</code>. Using <code>{{@site.lang}}</code> is preferred.<br>
        The <code>{{lang}}</code> helper will be removed in next version of Ghost and should not be used.
        Find more information about the <code>@site.lang</code> property <a href="${docsBaseUrl}site" target=_blank>here</a>.`,
        regex: /{{\s*?lang\s*?}}/g,
        helper: '{{lang}}'
    },
    'GS001-DEPR-CSS-KGMD': {
