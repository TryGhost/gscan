...
rules = {
    ...
    'GS001-DEPR-CSS-KGMD': {
        ...
        details: oneLineTrim`The <code>.kg-card-markdown</code> CSS class is deprecated and will no longer be used in Ghost 2.0.
    ...
    'GS050-CSS-KGWW': {
        ...
        details: oneLineTrim`The <code>.kg-width-wide</code> CSS class is required to use your theme with 2.0.
        Find out more about required theme changes for the Koenig editor <a href="${docsBaseUrl}ghost-editor" target=_blank>here</a>.`,
    ...
    'GS050-CSS-KGWF': {
        ...
        details: oneLineTrim`The <code>.kg-width-full</code>  CSS class is required to use your theme with 2.0.
        Find out more about required theme changes for the Koenig editor <a href="${docsBaseUrl}ghost-editor" target=_blank>here</a>.`,
    ...
    'GS050-CSS-KGGC': {
        ...
        details: oneLineTrim`The <code>.kg-gallery-container</code>  CSS class is required to use your theme with 2.0.
        Find out more about required theme changes for the Koenig editor <a href="${docsBaseUrl}ghost-editor" target=_blank>here</a>.`,
    ...
    'GS050-CSS-KGGR': {
        ...
        details: oneLineTrim`The <code>.kg-gallery-row</code>  CSS class is required to use your theme with 2.0.
        Find out more about required theme changes for the Koenig editor <a href="${docsBaseUrl}ghost-editor" target=_blank>here</a>.`,
    ...
    'GS050-CSS-KGGI': {
        ...
        details: oneLineTrim`The <code>.kg-gallery-image</code>  CSS class is required to use your theme with 2.0.
        Find out more about required theme changes for the Koenig editor <a href="${docsBaseUrl}ghost-editor" target=_blank>here</a>.`,
