...
rules = {
    ...
    'GS050-CSS-KGGC': {
        level: 'error',
        rule: 'The <code>.kg-gallery-container</code> CSS class is required to use your theme with 2.1',
        details: `The <code>.kg-gallery-container</code>  CSS class is required to use your theme with 2.1.
        Find out more about required theme changes for the Koenig editor <a href="${docsBaseUrl}ghost-editor" target=_blank>here</a>.`,
    ...
    'GS050-CSS-KGGR': {
        level: 'error',
        rule: 'The <code>.kg-gallery-row</code> CSS class is required to use your theme with 2.1',
        details: `The <code>.kg-gallery-row</code>  CSS class is required to use your theme with 2.1.
        Find out more about required theme changes for the Koenig editor <a href="${docsBaseUrl}ghost-editor" target=_blank>here</a>.`,
    ...
    'GS050-CSS-KGGI': {
        level: 'error',
        rule: 'The <code>.kg-gallery-image</code> CSS class is required to use your theme with 2.1',
        details: `The <code>.kg-gallery-image</code>  CSS class is required to use your theme with 2.1.
        Find out more about required theme changes for the Koenig editor <a href="${docsBaseUrl}ghost-editor" target=_blank>here</a>.`,
