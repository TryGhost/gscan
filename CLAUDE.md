...
NODE_ENV=testing vitest run test/010-package-json.test.js

# Run specific test pattern
NODE_ENV=testing vitest run test/*.test.js

# Debug mode testing
NODE_ENV=testing DEBUG=gscan:* vitest run test/checker.test.js
```
